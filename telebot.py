...
from v2.handlers.alert_commands import (
    ...
    handle_alert_geo_callback,
    handle_alert_geopage_callback,
    handle_alert_hour_callback,
    handle_alert_kind_callback,
    handle_alert_manage_callback,
    handle_alert_mode_callback,
    handle_alert_qtype_callback,
    handle_alert_quake_mag_callback,
    handle_alert_sel_callback,
...
I18N = {
    "fa": {
        ...
        "alerts_kind_fx": "💵 ارز",
        "alerts_kind_gold": "🥇 طلا",
        "alerts_kind_weather": "🌤 آب‌وهوا",
        "alerts_kind_quake": "🌍 زلزله",
        "alerts_ask_mode": "نوع هشدار ارز/طلا را انتخاب کن:",
        "alerts_mode_daily": "📅 ارسال روزانه (ساعت مشخص)",
        "alerts_mode_spike": "🚨 فقط جهش قیمت (همان لحظه)",
        "alerts_ask_pick_assets": "یک یا چند مورد را از لیست انتخاب کن، بعد «تمام»:",
        "alerts_pick_at_least_one": "حداقل یک مورد را انتخاب کن.",
        "alerts_btn_done_pick": "✅ تمام ({n})",
        "alerts_btn_cancel": "لغو",
        "alerts_btn_manage_id": "⚙️ مدیریت #{id}",
        "alerts_btn_back_list": "◀️ لیست",
        "alerts_manage_title": "مدیریت هشدار:",
        "alerts_added_multi": "{n} هشدار ثبت شد ✅",
        "alerts_quake_ask_geo": "هشدار زلزله آنی است (نه روزانه).\nفیلتر مکان را انتخاب کن:",
        "alerts_quake_pick_province": "🏛 انتخاب استان(ها)",
        "alerts_quake_pick_city": "🏙 انتخاب شهر(ها)",
        "alerts_quake_pick_both": "استان + شهر",
        "alerts_quake_pick_list": "موارد را انتخاب کن (چندتایی)، بعد تمام:",
        "alerts_quake_pick_cities_next": "حالا شهرها را هم انتخاب کن (اختیاری)، بعد تمام:",
        ...
        "alerts_ask_spike": "آستانه جهش٪ را انتخاب کن (ارسال همان لحظه):",
        "alerts_ask_spike_custom": "آستانه جهش٪ را بفرست (مثلاً ۳):",
        ...
        "alerts_list_title": "هشدارهای تو — برای هر مورد «مدیریت» را بزن:",
        "alerts_btn_delete": "🗑",
        "alerts_btn_enable": "▶️",
        "alerts_btn_disable": "⏸",
        "alerts_btn_test": "🧪 تست",
    ...
    "en": {
        ...
        "alerts_kind_fx": "💵 FX",
        "alerts_kind_gold": "🥇 Gold",
        "alerts_kind_weather": "🌤 Weather",
        "alerts_kind_quake": "🌍 Quake",
        "alerts_ask_mode": "Pick FX/gold alert mode:",
        "alerts_mode_daily": "📅 Daily at a set hour",
        "alerts_mode_spike": "🚨 Spike only (instant)",
        "alerts_ask_pick_assets": "Select one or more items, then Done:",
        "alerts_pick_at_least_one": "Select at least one item.",
        "alerts_btn_done_pick": "✅ Done ({n})",
        "alerts_btn_cancel": "Cancel",
        "alerts_btn_manage_id": "⚙️ Manage #{id}",
        "alerts_btn_back_list": "◀️ List",
        "alerts_manage_title": "Manage alert:",
        "alerts_added_multi": "{n} alerts saved ✅",
        "alerts_quake_ask_geo": "Quake alerts are instant (not daily).\nPick a location filter:",
        "alerts_quake_pick_province": "🏛 Provinces",
        "alerts_quake_pick_city": "🏙 Cities",
        "alerts_quake_pick_both": "Provinces + cities",
        "alerts_quake_pick_list": "Select items (multi), then Done:",
        "alerts_quake_pick_cities_next": "Now pick cities too (optional), then Done:",
        ...
        "alerts_ask_spike": "Pick spike threshold % (sent instantly):",
        "alerts_ask_spike_custom": "Send spike threshold % (e.g. 3):",
        "alerts_added_ok": "Alert saved ✅ — you can send a test now.",
        "alerts_add_fail": "Could not save alert: {detail}",
        "alerts_empty": "No alerts yet.",
        "alerts_list_title": "Your alerts — tap Manage on each:",
        "alerts_btn_delete": "🗑",
        "alerts_btn_enable": "▶️",
        "alerts_btn_disable": "⏸",
...
CALLBACK_ROUTE_DEPS = CallbackRouteDeps(
    ...
    handle_alert_mode_callback=lambda c, cq, p: handle_alert_mode_callback(ALERT_COMMAND_DEPS, c, cq, p),
    handle_alert_sel_callback=lambda c, cq, p: handle_alert_sel_callback(ALERT_COMMAND_DEPS, c, cq, p),
    handle_alert_qtype_callback=lambda c, cq, p: handle_alert_qtype_callback(ALERT_COMMAND_DEPS, c, cq, p),
    handle_alert_geo_callback=lambda c, cq, p: handle_alert_geo_callback(ALERT_COMMAND_DEPS, c, cq, p),
    handle_alert_geopage_callback=lambda c, cq, p: handle_alert_geopage_callback(
        ALERT_COMMAND_DEPS, c, cq, p
    ),
